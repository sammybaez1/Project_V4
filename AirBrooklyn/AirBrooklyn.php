...
<body>
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
            <a class="navbar-brand" href="AirBrooklyn.php">AirBrooklyn</a>
...
status as 'Status' 
from flights 
WHERE endAirport != 'AirBrooklyn' and date(departureTime) ="."'".$_SESSION['currentDate']."';");
...
status as 'Status' 
from flights 
WHERE endAirport = 'AirBrooklyn' and date(arrivalTime) =". "'".$_SESSION['currentDate']."';"); 
        ...
        <footer class="page-footer font-small indigo">
            <div class="footer text-center py-3">AirBrooklyn
            </div>
        </footer>
        <!-- Footer -->
