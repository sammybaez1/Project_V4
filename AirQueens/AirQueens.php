...
<body>
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
            <a class="navbar-brand" href="AirQueens.php">AirQueens</a>
...
status as 'Status' 
from flights 
WHERE endAirport != 'AirQueens' and date(departureTime) ="."'".$_SESSION['currentDate']."';");
...
status as 'Status' 
from flights 
WHERE endAirport = 'AirQueens' and date(arrivalTime) =". "'".$_SESSION['currentDate']."';"); 
        ...
        <footer class="page-footer font-small indigo">
            <div class="footer text-center py-3">AirQueens
            </div>
        </footer>
        <!-- Footer -->
